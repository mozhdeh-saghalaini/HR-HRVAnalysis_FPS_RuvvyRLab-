...
2. Data analysis with HRV Analysis MindWare:
    2.1. Spyder and required libraries Installation
    2.2. Preparing Python code for MindWare controlling - DONE! TEST ON THE MAIN SOFTWARE IS NEEDED
    2.3. Analyzing all .acq data
3. Data wrangling and cleaning - R CODE IS PREPARED!: "data_wrangling.R"
